---
title: "Bayes@: Approachable mini conferences on applied Bayesian statistics"
output: 
  html_document: 
    fig_caption: yes
---
...
Welcome! On this page you will find information regarding the Bayes@ series of mini-conferences.

Upcoming Bayes@ conferences
-----------------
...
Main Organizers: Rasmus Bååth, Alexander Holmes, Ullrika Sahlin and Jakob Lavröd <br>
Invited speakers: Maggie Lieu and Robert Grant

[More info and registration here!](lund2019/index.html)


What is a Bayes@ mini-conference?
----------------------------------
...
Arrange your own Bayes@ conference
--------------

So far Bayes@ has only been arranged at Lund University, Sweden. But we think that these types of events are so nice that more people should arrange them! We *definitely* don't claim any rights to any "Bayes@" brand, but you are free to use our logo ([here in svg format](media/bayes_at_logo_template_inkscape.svg) for editing in [Inkscape](https://inkscape.org/)). Also, if you do arrange a Bayes@ event, please let us know and we will add it to this page. Finally, if you want any tips, or want to discuss ideas regarding an event, feel free to reach us at rasmus.baath@gmail.com .

The format of a Bayes@ event has so far been something like the following:

* A one day workshop (we call it a mini-conference) with talks that aim at being accessible to an interested but disciplinary diverse audience.
* One or two longer presentation by invited speakers and a number of shorter submitted presentations.
* The topics can be anything related to Bayesian statistics and data analysis, but we try to discourage too technical presentations. 
* Free or cheap to attend.
* A tutorial to a topic in Bayesian statistics held just before the conference.