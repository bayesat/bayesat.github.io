...
The full program will be announced after the notifications to presenters have been sent out on the __18th of February__. Like last year the conference will run from 09:30 to 16:30 on the day of the event.
...
The prior – a key concept in Bayesian statistics which distinquishes it other statistical methods. Historically, the use of priors has caused some resentment against Bayesian statistics and it remains a controversial topic to date. In my talk, I will explain why we should not be too afraid of priors. At the same time, I want to hightlight situations where thinking about priors is mandatory and neccecary for reliable inference.
